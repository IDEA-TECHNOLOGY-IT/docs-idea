...
- **[Visão Gráfica e Tabela](https://idea-technology-it.github.io/docs-idea/financeiro/inadimplencia/#visao-grafica-e-tabela)** - pode ser navegada através do [botão](https://idea-technology-it.github.io/docs-idea/financeiro/intro/#botoes-para-diferentes-visoes) "ir para visualização em gráfico" ou "ir para visualização em tabela";
...
Além disso, a interação entre os gráficos é **bidirecional**: ao clicar em outro visual na página, como o gráfico [Aging - Inadimplência](https://idea-technology-it.github.io/docs-idea/financeiro/inadimplencia/#aging-inadimplencia), esta matriz será automaticamente filtrada com base na seleção feita. Da mesma forma, ao selecionar um item nesta matriz, ela filtrará os outros visuais, como gráficos de barras ou tabelas, permitindo uma análise interativa e detalhada que facilita a compreensão dos dados e a tomada de decisões informadas. Esse comportamento dinâmico cria uma experiência integrada, onde os usuários podem explorar os dados de forma fluida, investigando correlações e entendendo como diferentes categorias impactam a inadimplência.
...
A seleção de cabeçalhos de linha nesta matriz também permite combinações poderosas com a matriz de **Inadimplência por Filial, Projeto, Dimensão, Origem ou Cliente**, proporcionando ainda mais flexibilidade na análise. A capacidade de alternar entre diferentes combinações de cabeçalhos de linha em ambas as matrizes facilita a visualização de conexões relevantes entre clientes, projetos, filiais e dimensões. Por exemplo, o usuário pode optar por visualizar **Cliente** nesta matriz e **Filial** na [outra](https://idea-technology-it.github.io/docs-idea/financeiro/inadimplencia/#inadimplencia-por-cliente-origem-projeto-dimensao-ou-filial), ou explorar **Origem** aqui e **Projeto** na outra, ajustando as tabelas conforme as necessidades da análise.
...
O gráfico ilustra inadimplências acumulado por mês e ano, destacando três elementos principais:
...
- **A Receber Total por Mês:** Este número representa o valor total que era esperado para ser recebido naquele mês. Ele inclui todos os pagamentos ou contas a receber devidos dentro do período. Este valor fornece o contexto de quanta renda foi antecipada para o mês e serve como linha de base ao avaliar o comportamento de pagamento. Saber disso ajuda os usuários a entender a escala da atividade financeira e fornece um ponto claro de comparação ao avaliar as taxas de inadimplência;

- **Inadimplência por Mês:** Este número representa o valor de contas a receber vencidas ou não pagas para aquele mês específico. Ele mostra o nível de **inadimplência** (inadimplência) que ocorreu em relação ao que era esperado para ser recebido. Este valor é crucial para identificar tendências em pagamentos perdidos, destacando os meses em que a inadimplência aumentou e oferecendo insights sobre como as cobranças e o fluxo de caixa estão sendo impactados ao longo do tempo;

- **% Inadimplência por Mês:** Esta porcentagem mostra a proporção de **a receber** (total de recebíveis esperados) que não foi cobrada, expressa como uma porcentagem do total. Este valor é essencial para avaliar a gravidade da inadimplência em relação aos recebíveis gerais. Ele permite que os usuários acompanhem a eficiência das cobranças, comparem o desempenho entre os períodos e tomem medidas direcionadas no gerenciamento da saúde financeira.
