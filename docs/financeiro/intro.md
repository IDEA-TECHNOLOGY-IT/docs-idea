...
<div style="margin-bottom: 10px; display: flex; justify-content: center;">
  <img src="../../assets/flux/flux_tooltip_rec.png" alt="ToolTip Rec" style="margin-right: 10px;">
</div>
<div style="margin-bottom: 10px; display: flex; justify-content: center;">
  <img src="../../assets/flux/flux_tooltip_venc.png" alt="ToolTip Venc" style="margin-right: 10px; height: 150px;">
  <img src="../../assets/flux/flux_tooltip_inadim.png" alt="ToolTip Inadim" style="height: 150px;">
</div>
