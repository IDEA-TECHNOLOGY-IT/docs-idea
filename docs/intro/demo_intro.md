...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="../../assets/fat.png" alt="Idea Sales" style="width: 100px; height: auto; margin-right: 15px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="../../assets/flux.png" alt="Idea Finance" style="width: 100px; height: auto; margin-right: 15px;">
  <div>
...
<div style="display: flex; align-items: center;">
  <img src="../../assets/contabilidade_home.png" alt="Idea Accounting" style="width: 100px; height: auto; margin-right: 15px;">
  <div>
